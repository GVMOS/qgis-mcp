...
| `create_postgresql_connection` | Create PostgreSQL Connection | — | Validate and save a PostgreSQL Browser-panel connection with an existing QGIS Authentication Manager configuration; passwords are never accepted |
